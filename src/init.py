...
TABLES = {
    ...
    db_con.TABLE_SEMESTER: [f'{db_con.COLUMN_ID} INTEGER PRIMARY KEY AUTOINCREMENT', f'{db_con.COLUMN_NAME} TEXT UNIQUE', f'{db_con.COLUMN_IS_SELECTED} BOOLEAN DEFAULT 1'],
    db_con.TABLE_UNIT: [f'{db_con.COLUMN_ID} INTEGER PRIMARY KEY AUTOINCREMENT', f'{db_con.COLUMN_NAME} TEXT UNIQUE', f'{db_con.COLUMN_IS_SELECTED} BOOLEAN DEFAULT 1'],
    db_con.TABLE_LESSON: [f'{db_con.COLUMN_ID} INTEGER PRIMARY KEY AUTOINCREMENT', f'{db_con.COLUMN_NAME} TEXT UNIQUE', f'{db_con.COLUMN_IS_SELECTED} BOOLEAN DEFAULT 1'],
    db_con.TABLE_QUESTION_TYPE: [f'{db_con.COLUMN_ID} INTEGER PRIMARY KEY AUTOINCREMENT', f'{db_con.COLUMN_NAME} TEXT UNIQUE', f'{db_con.COLUMN_IS_SELECTED} BOOLEAN DEFAULT 1'],
    db_con.TABLE_KNOWLEDGE_POINT: [f'{db_con.COLUMN_ID} INTEGER PRIMARY KEY AUTOINCREMENT', f'{db_con.COLUMN_NAME} TEXT UNIQUE', f'{db_con.COLUMN_IS_SELECTED} BOOLEAN DEFAULT 1'],
    db_con.TABLE_ERROR_REASON: [f'{db_con.COLUMN_ID} INTEGER PRIMARY KEY AUTOINCREMENT', f'{db_con.COLUMN_NAME} TEXT UNIQUE', f'{db_con.COLUMN_IS_SELECTED} BOOLEAN DEFAULT 1']
}
